...
It's built against 2.12 and 2.13 versions:
   ...
   - 2.12:  [![Maven](https://img.shields.io/maven-central/v/com.github.imrafaelmerino/json-scala-values_2.12/4.0.0)](https://search.maven.org/artifact/com.github.imrafaelmerino/json-scala-values-generator_2.12/4.0.0/jar)

     [It's maintained in the branch scala-2.12](https://github.com/imrafaelmerino/json-scala-values/tree/scala-2.12)

     libraryDependencies += "com.github.imrafaelmerino" % "json-scala-values_2.12" % "4.0.0" % "test"
...
[![Maven](https://img.shields.io/maven-central/v/com.github.imrafaelmerino/json-dotty-values_0.22/4.0.0)](https://search.maven.org/artifact/com.github.imrafaelmerino/json-dotty-values_0.22/4.0.0/jar)
