...
```
// always true: if you insert a json.value, you'll get it back
json.inserting(path,json.value)(path) == json.value 
...
concise, with no ceremony at all. The binding * -> any means: any json.value different than the specified is allowed.
