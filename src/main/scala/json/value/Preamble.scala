...
object Preamble
{
  ...
  given Conversion[(String, json.value.JsNull.type), (JsPath, JsValue)] = p => (empty.appended(p._1), p._2)
  ...
  given Conversion[(Int, json.value.JsNull.type), (JsPath, JsValue)] = p => (empty.appended(p._1), p._2)
