...
object Preamble
{
  ...
  {
    p =>
      (NamedKey(p._1), IsStrSuchThat(s =>
                                     {
                                       if s == p._2 then Valid
  ...
  {
    p =>
      (NamedKey(p._1), IsLongSuchThat(s =>
                                      {
                                        if s == p._2 then Valid
                                        else Invalid(s"$s is not equals to $p._2")
                                      }
  ...
  {
    p =>
      (NamedKey(p._1), IsIntegralSuchThat(s =>
                                          {
                                            if s == p._2 then Valid
                                            else Invalid(s"$s is not equals to $p._2")
                                          }
  ...
  given Conversion[(String, BigDecimal), (NamedKey, JsSpec)] =
  {
    p =>
    {
      (NamedKey(p._1), IsDecimalSuchThat(s =>
                                         {
                                           if s == p._2 then Valid
                                           else Invalid(s"$s is not equals to $p._2")
                                         }
  ...
  given Conversion[(String, Double), (NamedKey, JsSpec)] =
  {
    p =>
    {
      (NamedKey(p._1), IsDecimalSuchThat(s =>
                                         {
                                           if s == BigDecimal(p._2) then Valid
                                           else Invalid(s"$s is not equals to $p._2")
                                         }
                                         ))
    }
  ...
  {
    p => (NamedKey(p._1), if p._2 then JsBoolSpecs.isTrue() else JsBoolSpecs.isFalse())
  }

  given Conversion[(String, JsObj), (NamedKey, JsSpec)] =
  {
    p =>
      (NamedKey(p._1), IsObjSuchThat(s =>
                                     {
                                       if s == p._2 then Valid
                                       else Invalid(s"$s is not equals to $p._2")
                                     }
  ...
  {
    p =>
      (NamedKey(p._1), IsArrayOfStrSuchThat(a =>
                                            {
                                              if a == p._2 then Valid
  ...
  given Conversion[Double, JsSpec] =
  {
    cons =>
      decimalSuchThat(s =>
                      {
                        if s == BigDecimal(cons) then Valid
                        else Invalid(s"$s is not equals to $cons")
                      }
                      )
  }
  ...
  {
    cons =>
      IsArrayOfValueSuchThat(a =>
                             {
                               if a == cons then Valid
  ...
  given Conversion[Boolean, JsSpec] =
  {
    cons =>
    {
      if cons then JsBoolSpecs.isTrue()
