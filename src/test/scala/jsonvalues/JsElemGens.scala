                     ...
                     )
{
  ...
  private val jsValueGen: Gen[JsElem] = Gen.frequency((valueFreq.str, jsStrGen),
                                                      ...
                                                      (valueFreq.arr, jsArrGen),
                                                      (valueFreq.obj, jsObjGen),
                                                      (valueFreq.nullFreq, Gen.const(JsNull.NULL))
                                                      )
  ...
  val jsObjGen: Gen[JsObj] =
  {
    ...
    } yield JsObj(scala.collection.immutable.HashMap[String, JsElem](pairs: _*))
